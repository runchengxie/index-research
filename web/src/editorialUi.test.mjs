...
test("现金流指数有独立 Tab、性能图和调仓频率",()=>{assert.match(app,/href="#cashflow"/);assert.match(app,/CashflowPerformanceChart/);assert.match(app,/rebalance_frequency/);assert.match(chart,/CashflowPerformanceChart/)});
